...
AS
    ...
    SELECT 
        ...
        NULLIF(TCA.VALUE, 0) AS TOTAL_CURRENT_ASSETS,
        NULLIF(TCL.VALUE, 0) AS TOTAL_CURRENT_LIABILITIES,
        NULLIF(TL.VALUE, 0) AS TOTAL_LIABILITIES,
        NULLIF(CE.VALUE, 0) AS COMMON_EQUITY,
        NULLIF(RE.VALUE, 0) AS RETAINED_EARNINGS,
        NULLIF(TEQ.VALUE, 0) AS TOTAL_EQUITY,
        NULLIF(NI.VALUE, 0) AS NET_INCOME
